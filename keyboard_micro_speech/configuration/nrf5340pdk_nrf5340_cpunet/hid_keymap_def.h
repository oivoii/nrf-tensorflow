...
static const struct hid_keymap hid_keymap[] = {
	...
	{ KEY_ID(0x00, 0x4F), 0x004F, REPORT_ID_KEYBOARD_KEYS }, /* right arrow */
	{ KEY_ID(0x00, 0x50), 0x0050, REPORT_ID_KEYBOARD_KEYS }, /* left arrow */
	{ KEY_ID(0x00, 0x51), 0x0051, REPORT_ID_KEYBOARD_KEYS }, /* down arrow */
	{ KEY_ID(0x00, 0x52), 0x0052, REPORT_ID_KEYBOARD_KEYS }, /* up arrow */
};
